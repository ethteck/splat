...
class SplatOpts:
    ...
    ld_sort_segements_by_vram_class_dependency: bool
...
def _parse_yaml(
    ...
    ret = SplatOpts(
        ...
        ld_sort_segements_by_vram_class_dependency=p.parse_opt(
            "ld_sort_segements_by_vram_class_dependency", bool, False
        ),
