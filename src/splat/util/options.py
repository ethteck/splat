...
class SplatOpts:
    ...
    # Changes the definition of the generated `INCLUDE_ASM` to use the maspsx hack workaround.
    # https://github.com/mkst/maspsx?tab=readme-ov-file#include_asm-reordering-workaround-hack
    maspsx_include_asm_hack: bool
...
def _parse_yaml(
    ...
    ret = SplatOpts(
        ...
        maspsx_include_asm_hack=p.parse_opt("maspsx_include_asm_hack", bool, False),
