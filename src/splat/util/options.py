...
class SplatOpts:
    ...
    # TODO document
    elf_section_list_path: Path | None
    ...
    ld_symbol_header_path: Path | None
    ...
    asm_emit_size_directive: bool | None
    ...
    global_vram_start: int | None
    global_vram_end: int | None
...
class OptParser:
    ...
    def parse_opt(self, opt: str, t: type[T], default: T | None = None) -> T:
