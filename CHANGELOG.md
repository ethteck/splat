...
### 0.20.1
* splat now uses [crunch64](https://github.com/decompals/crunch64) as a dependency for handling decompression of various formats, starting with Yay0
...
* Removed utility cli Yay0decompress.py script; see crunch64-cli for a much more performant (de)compression CLI tool
