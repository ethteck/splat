...
class GCRARCArchive:
    def __init__(self, file_path: Path, file_bytes):
        ...
        self.file_data_offset = (
            struct.unpack(">I", file_bytes[0x000C:0x0010])[0] + 0x0020
        )
    ...
    def emit_config(self, config_path: Path):
        ...
        lines.append(
            f"sync_file_ids_to_indices: {str(self.data_header.sync_file_ids_to_indices)}\n"
        )
...
class GCRARCDataHeader:
    def __init__(self, offset, file_bytes):
        self.node_count = struct.unpack(
            ">I", file_bytes[offset + 0x0000 : offset + 0x0004]
        )[0]
        self.node_offset = (
            struct.unpack(">I", file_bytes[offset + 0x0004 : offset + 0x0008])[0]
            + 0x0020
        )

        self.file_entry_count = struct.unpack(
            ">I", file_bytes[offset + 0x0008 : offset + 0x000C]
        )[0]
        self.file_entry_offset = (
            struct.unpack(">I", file_bytes[offset + 0x000C : offset + 0x0010])[0]
            + 0x0020
        )

        self.string_table_size = struct.unpack(
            ">I", file_bytes[offset + 0x0010 : offset + 0x0014]
        )[0]
        self.string_table_offset = (
            struct.unpack(">I", file_bytes[offset + 0x0014 : offset + 0x0018])[0]
            + 0x0020
        )

        self.next_free_file_id = struct.unpack(
            ">H", file_bytes[offset + 0x0018 : offset + 0x001A]
        )[0]
...
class GCRARCNode:
    def __init__(self, offset, file_bytes, string_table_bytes):
        ...
        self.name_offset = struct.unpack(
            ">I", file_bytes[offset + 0x0004 : offset + 0x0008]
        )[0]
        self.name_hash = struct.unpack(
            ">H", file_bytes[offset + 0x0008 : offset + 0x000A]
        )[0]
        self.file_entry_count = struct.unpack(
            ">H", file_bytes[offset + 0x000A : offset + 0x000C]
        )[0]
        self.first_file_entry_index = struct.unpack(
            ">I", file_bytes[offset + 0x000C : offset + 0x0010]
        )[0]
...
class GCRARCFileEntry:
    def __init__(self, offset, file_bytes, string_table_bytes):
        self.file_id = struct.unpack(
            ">H", file_bytes[offset + 0x0000 : offset + 0x0002]
        )[0]
        self.name_hash = struct.unpack(
            ">H", file_bytes[offset + 0x0002 : offset + 0x0004]
        )[0]
