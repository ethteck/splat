...
class PsxSegHeader(CommonSegHeader):
    ...
    def parse_header(self, rom_bytes):
        ...
        header_lines.append(self.get_line("word", rom_bytes[0x10:0x14][::-1], "Initial PC"))
        header_lines.append(self.get_line("word", rom_bytes[0x14:0x18][::-1], "Initial $gp/r28"))
        ...
        header_lines.append(self.get_line("word", rom_bytes[0x20:0x24][::-1], ".data start"))
        header_lines.append(self.get_line("word", rom_bytes[0x24:0x28][::-1], ".data size"))
        header_lines.append(self.get_line("word", rom_bytes[0x28:0x2C][::-1], ".bss start"))
        header_lines.append(self.get_line("word", rom_bytes[0x2C:0x30][::-1], ".bss size"))
        header_lines.append(self.get_line("word", rom_bytes[0x30:0x34][::-1], "Initial $sp/r29 & $fp/r30 base"))
        header_lines.append(self.get_line("word", rom_bytes[0x34:0x38][::-1], "Initial $sp/r29 & $fp/r30 offset"))
